        ...
        <div class="panel-body">
            ...
            <div class="edit">
                ...
                <Checkbox-group v-model="korder" style="display: inline;">
                    <Checkbox label="trip_table.user_id">
                        <span>员工工号</span>
                    </Checkbox>
                    <Checkbox label="d_id">
                        <span>部门编号</span>
...
export default {
    ...
    methods: {
        ...
        deleteOk: function () {
            ...
            for (let item in data) {
                ...
                this.$socket.emit('delete', obj, function (status) {
                    if (status) {
                        that.tripData = that.tripData.filter(i => i['number'] !== item['number']);
                    } else {
        ...
        renderOperate: function (h, params) {
            ...
            } else if (row.status === 3 && this.type < 4) {
                return h('div', [h('Button', {
                    props: {
                        type: 'error',
                        size: 'small'
